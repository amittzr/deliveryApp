                    ...
                    packagesHtml += `
                        <div class="package" data-package-id="${packageId}">
                            <div class="package-header">
                                <span class="package-id clickable" onclick="showPackageMap('${packageId}')">Package: ${packageData._id}</span>
                                <span class="prod-id">Product ID: ${packageData.prod_id || 'N/A'}</span>
                            </div>
                            ...
                            <div>
                                ...
                                <span class="customer-id" onclick="toggleCustomerInfo('${packageId}')">${packageData.customer_id?.name || ''}</span>
                            </div>

                            <div class="customer-info" id="customer-${packageId}" style="display: none;">
                                <p><strong>Name:</strong> ${packageData.customer_id?.name || 'N/A'}</p>
                                <p><strong>Email:</strong> ${packageData.customer_id?.email || 'N/A'}</p>
                                <p><strong>Address:</strong> ${packageData.customer_id?.address?.street || ''} ${packageData.customer_id?.address?.number || ''}, ${packageData.customer_id?.address?.city || ''}</p>
                            </div>
                            ...
                            <p><strong>Status:</strong> <span class="status ${statusClass}">${packageData.status || 'N/A'}</span></p>
...
function confirmDelete() {
    console.log("Deleting package:", currentPackageId, "for company:", currentCompanyId); //chrck
